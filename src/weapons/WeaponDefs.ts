...
export const WEAPON_DEFS: Record<WeaponId, WeaponDef> = {
  pistol: {
    ...
    recoilPitch: 0.02, recoilYaw: 0.034, recoilRamp: 1.6, recoilSway: 0.9, recoilRecovery: 6.5, burstReset: 0.35,
    kickback: 0.08,
  ...
  rifle: {
    ...
    recoilPitch: 0.0126, recoilYaw: 0.044, recoilRamp: 4.0, recoilSway: 0.44, recoilRecovery: 4.6, burstReset: 0.3,
    kickback: 0.06,
  ...
  deagle: {
    ...
    recoilPitch: 0.05, recoilYaw: 0.051, recoilRamp: 1.2, recoilSway: 1.3, recoilRecovery: 5.4, burstReset: 0.4,
    kickback: 0.16,
  ...
  smg: {
    ...
    recoilPitch: 0.01, recoilYaw: 0.037, recoilRamp: 5.5, recoilSway: 0.62, recoilRecovery: 5.0, burstReset: 0.3,
    kickback: 0.045,
