...
export const WEAPON_DEFS: Record<WeaponId, WeaponDef> = {
  pistol: {
    ...
    spreadPerShot: 0.012, spreadMax: 0.095, spreadRecovery: 0.09,
    recoilPitch: 0.037, recoilYaw: 0.034, recoilRamp: 1.6, recoilSway: 0.9, recoilRecovery: 6.5, burstReset: 0.35,
    kickback: 0.08,
  ...
  rifle: {
    ...
    spreadPerShot: 0.0105, spreadMax: 0.14, spreadRecovery: 0.075,
    recoilPitch: 0.04, recoilYaw: 0.044, recoilRamp: 4.0, recoilSway: 0.44, recoilRecovery: 4.6, burstReset: 0.3,
    kickback: 0.06,
  ...
  deagle: {
    ...
    spreadPerShot: 0.038, spreadMax: 0.13, spreadRecovery: 0.11,
    recoilPitch: 0.078, recoilYaw: 0.051, recoilRamp: 1.2, recoilSway: 1.3, recoilRecovery: 5.4, burstReset: 0.4,
    kickback: 0.16,
  ...
  smg: {
    ...
    spreadPerShot: 0.0095, spreadMax: 0.15, spreadRecovery: 0.08,
    recoilPitch: 0.023, recoilYaw: 0.037, recoilRamp: 5.5, recoilSway: 0.62, recoilRecovery: 5.0, burstReset: 0.3,
    kickback: 0.045,
  ...
  sniper: {
    ...
    spreadPerShot: 0.06, spreadMax: 0.22, spreadRecovery: 0.2,
    recoilPitch: 0.099, recoilYaw: 0.034, recoilRamp: 1.0, recoilSway: 2.1, recoilRecovery: 3.2, burstReset: 0.8,
    kickback: 0.26,
  ...
  shotgun: {
    ...
    spreadPerShot: 0.013, spreadMax: 0.12, spreadRecovery: 0.12,
    recoilPitch: 0.063, recoilYaw: 0.051, recoilRamp: 1.0, recoilSway: 1.6, recoilRecovery: 4.0, burstReset: 0.5,
    kickback: 0.21,
